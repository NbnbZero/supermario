...
{
   public abstract class BigMarioSwimmingSprite : MarioSprite
    {
        private int _currentSwimmingFrame;
        private int _totalSwimmingFrame = MarioSpriteFactory.Instance.BigMarioSpriteSwimmingSheetColumn;
        ...
        protected BigMarioSwimmingSprite(Texture2D texture) : base(texture)
        {
