...
namespace SuperMario.Sprites.Mario
{
    ...
    {
        public JumpRightBigMarioSprite(Texture2D texture, Vector2 location) : base(texture, location)
        {
            Width = MarioSpriteFactory.Instance.BigMarioWidth;
            Height = MarioSpriteFactory.Instance.BigMarioHeight;

            TextureX = (int)MarioSpriteFactory.Instance.JumpRightBigMarioCord.X;
            TextureY = (int)MarioSpriteFactory.Instance.JumpRightBigMarioCord.Y;
        }
